...
import isComponentOfType from '../../common/is-component-of-type';
        ...
        renderHeaders(headers) {
            return headers.map((item, idx) => {
                return React.cloneElement(item, {
                    ...
                    onClick: (event, index) => {
                        /**
                         * 调用props传入的onChange()函数
                         * 回调父组件handleTabChange()函数
                         * 传入跳转tab的index
                         */
            ...
            return (
                <div data-react-toolbox="tabs" className={classNames}>
                    ...
                    <div className={theme.navigationContainer}>
                        ...
                        {/* {hasLeftArrow && <div className='' onClick={this.scrollRight}></div>} */}
                        ...
                        {/* {hasRightArrow && <div className='' onClick={this.scrollLeft}></div>} */}

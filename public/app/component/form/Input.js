...
var Input = React.createClass({
    ...
    renderLabel: function (children) {
        ...
        return (
            <label
                ...
                {this.props.label}
                {this.props.labeladd ?
                    (<span style={{ color: 'red', marginLeft: 4 }}>*</span>) : null}
            </label>
        );
    },
    renderInputGroup: function (children) {
        ...
        var addonBefore = this.props.addonBefore ? (
                <span className={classNames(addOnClassName, this.props.addFirstClass)}
                        key='addonBefore'>
    ...
    renderCheckboxAndRadioWrapper: function (children) {
        return this.props.inline ? children : (
            <div className={this.setClassNamespace(this.props.type)}
        ...
        switch (this.props.type) {
            case 'radio':
                if (this.props.checked) {
                    ...
                    uncheckicon = (
                        <Icon icon='record' className={this.props.iconclass}
                            style={{ color: '#ccc' }} />
                    );
                }
                break;
    ...
    renderInput: function () {
        ...
        switch (this.props.type) {
            case 'textarea':
                input = (
                    <textarea defaultDisabled={this.props.defdisabled}
            ...
            case 'reset':
                input = (
                    <Button {...inputProps} componentTag='input' ref='field' key='field' />
                );
                break;
            case 'radio':
            case 'checkbox':
                input = (
                    <input defaultDisabled={this.props.defdisabled}
                        defaultValue={this.props.defvalue}

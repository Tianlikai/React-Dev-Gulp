...
var TimePicker = React.createClass({
    ...
    setSelectedMinute: function (event) {
        var viewDate = this.state.viewDate;
        var minute = parseInt(event.target.innerHTML.split(':')[1], 0);
    ...
    setSelectedHour: function (event) {
        var viewDate = this.state.viewDate;
        var hour = parseInt(event.target.innerHTML, 0);
        ...
        var content = (
            <div className={this.prefixClass('time-box')}>
                <div style={{ width: '70%', margin: '0 auto' }}>
                    <Icon className='fa-chevron-up' onClick={this.addHour} />
                    <Icon className='fa-chevron-up' onClick={this.addMinute} />
                </div>
                ...
                <div style={{ width: '70%', margin: '0 auto' }}>
                    <Icon className='fa-chevron-down' onClick={this.subtractHour} />
                    <Icon className='fa-chevron-down' onClick={this.subtractMinute} />
                </div>
            </div>
        );
...
var SubPicker = React.createClass({
    ...
    render: function () {
        ...
        return (
            <div className={prefixClass(this.props.displayName)}
                style={this.props.style}>
                <table className={prefixClass('table')}>
                    <thead>
                        <tr className={prefixClass('header')}>
                            ...
                            <th className={prefixClass('switch')}
                                colSpan="5"

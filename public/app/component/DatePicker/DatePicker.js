...
var dateUtils = require('../../common/DateUtil');
...
var DatePicker = React.createClass({
    ...
    renderDays: function () {
        return (
            <DaysPicker style={this.state.displayed.days}
...
var DaysPicker = React.createClass({
    ...
    renderDays: function () {
        ...
        var currentDate = new Date(selectedDate.getFullYear(),
            selectedDate.getMonth(), selectedDate.getDate(), 0, 0, 0, 0).valueOf();
        ...
        while (prevMonth.valueOf() < nextMonth) {
            ...
            cells.push(
                <td key={prevMonth.getMonth() + '-' + prevMonth.getDate()}
    ...
    render: function () {
        ...
        return (
            <div className={prefixClass('days')} style={this.props.style}>
                <table className={prefixClass('table')}>
                    <thead>
                        <tr className={prefixClass('header')}>
                            ...
                            <th className={prefixClass('switch')} colSpan="5"
...
var MonthsPicker = React.createClass({
    ...
    renderMonths: function () {
        ...
        while (i < 12) {
            ...
            if (this.props.viewDate.getFullYear() === this.props.selectedDate.getFullYear()
                    && i === month) {
                classes[this.prefixClass('active')] = true;
            }
...
var SubPicker = React.createClass({
    ...
    render: function () {
        ...
        return (
            <div className={prefixClass(this.props.displayName)} style={this.props.style}>
                <table className={prefixClass('table')}>
                    <thead>
                        <tr className={prefixClass('header')}>

/*
 * @Author: jason.tian 
 * @Date: 2017-12-13 14:59:45 
 * @Last Modified by: jason.tian
 * @Last Modified time: 2017-12-20 17:09:42
 */
...
const downFile = function (blob, fileName) {
...
module.exports = class ExportJsonExcel {
    ...
    instance() {
        ...
        let stram = new Blob([s2ab(wbout)], {
            type: 'application/octet-stream'
        });
        downFile(stram, _this.fileName + '.xlsx');
    }
